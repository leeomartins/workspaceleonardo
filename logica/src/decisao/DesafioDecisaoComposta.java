...
public class DesafioDecisaoComposta {
	...
	public static void main(String[] args) {
		 ...
		 *  - Se a qtde estiver entre 10 e 20 - valor unitário tera 10% de redução
		 *  - Se a qtde estiver entre 5 e 9 - valor unitário tera 5% de redução
		...
		float valorUnitario = Float.parseFloat(JOptionPane.showInputDialog("Qual o valor unitário do produto?"));
		...
		System.out.println("O valor do produto " + produto + " é R$" + valorUnitario);
